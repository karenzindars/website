      ...
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form ref={form} onSubmit={sendEmail}>
          ...
          <button
            disabled={loading}
            type="submit"
            className="text-white bg-blue-700 w-full md:w-1/4 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
              {submitText}
            </button>
        </form>
      </div>
